...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        m_aboutDoshAction = new QAction(MainWindow);
        m_aboutDoshAction->setObjectName(QStringLiteral("m_aboutDoshAction"));
        m_aboutDoshAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutDoshAction);
        ...
        QObject::connect(m_aboutDoshAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutDoshAction->setText(QApplication::translate("MainWindow", "About Dosh", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND DOSH", 0));
